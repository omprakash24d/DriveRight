...
export async function Footer() {
  ...
  return (
    <footer className="bg-secondary/30 dark:bg-card border-t">
      <div className="mx-auto w-full max-w-screen-xl container-padding py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="flex items-center gap-3">
              <Car className="h-8 w-8 text-primary" />
              <span className="self-center heading-md text-foreground">
                {settings.schoolName}
              </span>
            </Link>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
            ...
            <div>
              ...
              <ul className="text-muted-foreground font-medium">
                ...
                <li className="mb-4">
                  <Link href="/ll-exam-pass" className="hover:underline">
                    LL Exam Pass Info
                  </Link>
                </li>
                <li className="mb-4">
                  <Link href="/license-print" className="hover:underline">
                    DL Print Request
                  </Link>
                </li>
                <li className="mb-4">
                ...
                <li className="mb-4">
                  <Link href="/certificate/verify" className="hover:underline">
                    Verify Certificate
                  </Link>
                </li>
              </ul>
