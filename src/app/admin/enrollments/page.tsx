...
export default function AdminEnrollmentsPage() {
  ...
  const handleStatusChange = async (id: string, newStatus: EnrollmentStatus) => {
    ...
    // Close the dialog before making the async call for a faster UI response
    ...
    try {
        ...
        // Refetch to get the latest remarks data
        fetchEnrollments(); 
    } catch (error) {
  ...
  const handleExport = () => {
    ...
    const csvContent = [
      ...
      ...enrollments.map(e => [
        ...
        sanitizeForCsv(format(e.createdAt.toDate(), "yyyy-MM-dd HH:mm:ss")),
            ...
            <TableBody>
              {isLoading ? (
                ...
                enrollments.map((enrollment) => (
                    ...
                    <TableCell>{format(enrollment.createdAt.toDate(), "PPP")}</TableCell>
                    <TableCell>
                                ...
                                <div>
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Button size="sm" variant="secondary" onClick={handleSaveRemarks}><Save className="mr-2 h-4 w-4" /> Save Remarks</Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
