...
import {
  updateLicensePrintInquiry,
  type LicensePrintInquiryStatus,
} from "@/services/licensePrintInquiriesService";
...
export function AdminLicenseInquiriesView({
  initialInquiries,
}: AdminLicenseInquiriesViewProps) {
    ...
    <div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage user requests for driving license documents.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
                      ...
                      <TableCell className="text-right">
                        ...
                        >
                          ...
                          <DialogContent>
                            <DialogHeader>
                              <DialogTitle>
                                Manage Request from {inquiry.name}
                              </DialogTitle>
                              <DialogDescription>
                            ...
                            <div className="grid gap-4 py-4">
                              <Card>
                                ...
                                <CardContent className="space-y-1 text-sm pt-4">
                                  <p>
                                    <strong>DL No.:</strong> {inquiry.dlNumber}
                                  </p>
                                  <p>
                                    <strong>DOB:</strong>{" "}
                                    {isValid(dobDate)
                              ...
                              <div className="space-y-2">
                                ...
                                <Select
                                  ...
                                  onValueChange={(value) =>
                                    setStatus(
                                      value as LicensePrintInquiryStatus
                                    )
                                  }
                                >
                              ...
                              <div className="space-y-2">
                                <Label htmlFor="notes">
                                  Admin Notes (will be sent to user)
                                </Label>
                                <Textarea
                                  id="notes"
                                  value={notes}
