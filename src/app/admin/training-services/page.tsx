...
import { getTrainingServices, deleteTrainingService, type TrainingService } from "@/services/quickServicesService";
import { Skeleton } from "@/components/ui/skeleton";

export default function AdminTrainingServicesPage() {
  ...
  const fetchServices = async () => {
    setIsLoading(true);
    try {
        const fetchedServices = await getTrainingServices();
        setServices(fetchedServices);
    } catch (error) {
        toast({
            variant: "destructive",
            title: "Error",
            description: "Could not fetch training services.",
        });
    } finally {
        setIsLoading(false);
    }
