      ...
      <div className="max-w-2xl mx-auto">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <InputField
                  ...
                  description="Your result will be sent to this email."
                  isRequired
                />
                <InputField
                  control={form.control}
                  ...
                  description="You can find this on the official Parivahan registration portal."
                  isRequired
                />
                <DatePickerField
                  control={form.control}
        ...
        <Alert className="mt-8">
          ...
          <AlertDescription className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <p>
              For other services like checking application status, please visit the official Parivahan Sewa portal.
            </p>
            <Button asChild variant="link" className="p-0 h-auto mt-2 sm:mt-0">
              <Link
                href="https://sarathi.parivahan.gov.in/sarathiservice/applicationStatus.do"
                target="_blank"
